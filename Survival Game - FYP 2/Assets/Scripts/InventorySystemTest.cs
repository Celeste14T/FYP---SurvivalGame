...
public class InventorySystem : MonoBehaviour
{
    ...
    public PickItems[] availableItems; //List with Prefabs of all the available items
    ...
    void FixedUpdate()
    {
        ...
        if (Physics.Raycast(ray, out hit, 2.5f))
        {
            ...
            {
                if ((detectedItem == null || detectedItem.transform != objectHit) && objectHit.GetComponent<PickItems>() != null)
                {
                    PickItems itemTmp = objectHit.GetComponent<PickItems>();
